...
$_select['multiroom_tx_bfr'] .= "<option value=\"64\" " . (($cfgMultiroom['tx_bfr'] == '64') ? "selected" : "") . ">64</option>\n";
$_select['multiroom_tx_bfr'] .= "<option value=\"96\" " . (($cfgMultiroom['tx_bfr'] == '96') ? "selected" : "") . ">96</option>\n";
$_select['multiroom_tx_bfr'] .= "<option value=\"128\" " . (($cfgMultiroom['tx_bfr'] == '128') ? "selected" : "") . ">128 (Default)</option>\n";
