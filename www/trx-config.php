...
// Sender
$_select['multiroom_tx_on']  .= "<input type=\"radio\" name=\"multiroom_tx\" id=\"toggle-multiroom-tx-1\" value=\"On\" " . (($_SESSION['multiroom_tx'] == 'On') ? "checked=\"checked\"" : "") . ">\n";
$_select['multiroom_tx_off'] .= "<input type=\"radio\" name=\"multiroom_tx\" id=\"toggle-multiroom-tx-2\" value=\"Off\" " . (($_SESSION['multiroom_tx'] == 'Off') ? "checked=\"checked\"" : "") . ">\n";
...
$_select['multiroom_tx_frame_size'] .= "<option value=\"960\" " . (($cfgMultiroom['tx_frame_size'] == '960') ? "selected" : "") . ">20</option>\n";
$_select['multiroom_tx_frame_size'] .= "<option value=\"1920\" " . (($cfgMultiroom['tx_frame_size'] == '1920') ? "selected" : "") . ">40 (Default)</option>\n";
...
$_select['multiroom_rx_jitter_bfr'] .= "<option value=\"32\" " . (($cfgMultiroom['rx_jitter_bfr'] == '32') ? "selected" : "") . ">32 (Default)</option>\n";
$_select['multiroom_rx_jitter_bfr'] .= "<option value=\"48\" " . (($cfgMultiroom['rx_jitter_bfr'] == '48') ? "selected" : "") . ">48</option>\n";
$_select['multiroom_rx_jitter_bfr'] .= "<option value=\"64\" " . (($cfgMultiroom['rx_jitter_bfr'] == '64') ? "selected" : "") . ">64</option>\n";
...
$_select['multiroom_rx_frame_size'] .= "<option value=\"960\" " . (($cfgMultiroom['rx_frame_size'] == '960') ? "selected" : "") . ">20</option>\n";
$_select['multiroom_rx_frame_size'] .= "<option value=\"1920\" " . (($cfgMultiroom['rx_frame_size'] == '1920') ? "selected" : "") . ">40 (Default)</option>\n";
