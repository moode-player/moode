...
$_select['multiroom_tx_frame_size'] .= "<option value=\"480\" " . (($cfgMultiroom['tx_frame_size'] == '480') ? "selected" : "") . ">10 (Default)</option>\n";
...
$_select['multiroom_rx_frame_size'] .= "<option value=\"480\" " . (($cfgMultiroom['rx_frame_size'] == '480') ? "selected" : "") . ">10 (Default)</option>\n";
