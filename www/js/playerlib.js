	...
	if (typeof data[i].file != 'undefined') {
		...
		// radio stations, playlist items
			...
			// cue sheet, use song file action menu
				...
				output += '"><div class="db-icon db-song db-browse db-action"><a class="btn" href="#notarget" data-toggle="context" data-target="#context-menu-folder-item"><i class="fas fa-list-ul icon-root sx style="float:left;"></i></a></div><div class="db-entry db-song db-browse">';
				itemType = 'Cue sheet';
			}
