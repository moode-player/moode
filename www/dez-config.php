...
$_select['noise_shaping'] .= "<option value=\"2\" " . (($cfgDeezer['noise_shaping'] == '2') ? "selected" : "") . ">Conservative (Default)</option>\n";
$_select['noise_shaping'] .= "<option value=\"3\" " . (($cfgDeezer['noise_shaping'] == '3') ? "selected" : "") . ">Balanced</option>\n";
