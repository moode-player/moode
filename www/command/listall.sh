...
find /mnt/NAS -depth -mindepth 1 -type f -regex ".*\.${TYPES_REGEX}" -printf "file: "NAS/"%P\n"
find /mnt/SDCARD -depth -mindepth 1 -type f -regex ".*\.${TYPES_REGEX}" -printf "file: "SDCARD/"%P\n"
find /mnt/UPNP -depth -mindepth 1 -type f -regex ".*\.${TYPES_REGEX}" -printf "file: "UPNP/"%P\n"

# Search all subdirectories under /media
# Have to prepend "USB/" to results to match MPD's structure
find /media -depth -mindepth 1 -type f -regex ".*\.${TYPES_REGEX}" -printf "file: "USB/"%P\n"
