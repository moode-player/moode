...
find /mnt/NAS -depth -mindepth 1 -type f -regex ".*\.${TYPES_REGEX}" -printf "file: %P\n"
find /mnt/SDCARD -depth -mindepth 1 -type f -regex ".*\.${TYPES_REGEX}" -printf "file: %P\n"
find /mnt/UPNP -depth -mindepth 1 -type f -regex ".*\.${TYPES_REGEX}" -printf "file: %P\n"
