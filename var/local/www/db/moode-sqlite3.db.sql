...
INSERT INTO cfg_radio (id, station, name, type, logo, genre, broadcaster, language, country, region, bitrate, format, geo_fenced, home_page, monitor) VALUES (247, 'https://podzone.multiradio.it/mp3/multiradio.mp3', 'Multiradio', 'r', 'local', 'Adult Contemporary', 'Multiradio', 'Italian', 'Italy', 'Europe', '192', 'AAC', 'Yes', 'https://www.multiradio.it', 'No');
